...
export function scoreBand(score) {
  if (score >= 8) return { color: "#34d399", label: "Strong", bg: "rgba(52,211,153,0.12)" };
  if (score >= 6) return { color: "#fbbf24", label: "Watch", bg: "rgba(251,191,36,0.12)" };
  return { color: "#f87171", label: "At Risk", bg: "rgba(248,113,113,0.12)" };
}

/** Map a 0-10 risk score (higher = worse) to a color. */
export function riskColor(risk) {
  if (risk >= 7) return "#f87171";
